...
public class BirthSearch {
	...
	public static void main(String[] args) throws InterruptedException {
       ...
       driver.navigate().to("https://ok2explore.health.ok.gov/App");
		...
		//FirstName
		driver.findElement(By.xpath("//label[text()='First Name:']//following::input[1]")).sendKeys("Step*");
		driver.manage().timeouts().implicitlyWait(50, TimeUnit.SECONDS);	
		//LastName
		
		driver.findElement(By.xpath("//label[text()='Last Name:']//following::input[1]")).sendKeys("Wa*");
		driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);	
		//BirthYear
		driver.findElement(By.xpath("//label[text()='Birth Date:']//following::input[3]")).sendKeys("1980");
		driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);	
		...
		//FirstName
		     driver.findElement(By.xpath("//label[text()='First Name:']//following::input[1]")).clear();
				...
				GenderSelection.sendKeys("Female");
				Thread.sleep(2);
